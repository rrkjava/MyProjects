...
public class QDepartment extends EntityPathBase<Department> {
    ...
    private static final long serialVersionUID = 852101264L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QDepartment department1 = new QDepartment("department1");

    public final QEntityBase _super = new QEntityBase(this);

    public final QDepartment department;

    public final QDepartmentType departmentType;
    ...
    public QDepartment(Class<? extends Department> type, PathMetadata metadata, PathInits inits) {
        ...
        this.departmentType = inits.isInitialized("departmentType") ? new QDepartmentType(forProperty("departmentType")) : null;
    }

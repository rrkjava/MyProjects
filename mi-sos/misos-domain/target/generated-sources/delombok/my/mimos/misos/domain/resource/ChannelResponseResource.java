...
public class ChannelResponseResource extends ChannelBaseResource {
	...
	public ChannelResponseResource() {
	}
	...
	public java.lang.String toString() {
		return "ChannelResponseResource(statusType=" + this.getStatusType() + ", statusCode=" + this.getStatusCode() + ", status=" + this.getStatus() + ")";
	}
	...
	public boolean equals(final java.lang.Object o) {
		...
		if (!(o instanceof ChannelResponseResource)) return false;
		final ChannelResponseResource other = (ChannelResponseResource) o;
	...
	protected boolean canEqual(final java.lang.Object other) {
		return other instanceof ChannelResponseResource;
	}
